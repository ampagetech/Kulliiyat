...
# Physics Page Function
def physics_page():
    st.title("Physics Tutor")
    st.write("Welcome! I'm here to help you with your SS physics questions. Let's explore the fascinating world of Physics!")

    # --- Chat Box Section ---
    st.header("Ask a Physics Question")
    st.write("Type your physics question below, and I'll do my best to explain it in a way that's easy to understand:")

    # Chat input box
    user_input = st.text_input("Ask me a physics question", placeholder="e.g., What is Newton's First Law of Motion?")
